...
of the sequencing center have much less representation 
...
* I strongly recommend using  
  the [FastQC](http://www.bioinformatics.babraham.ac.uk/projects/fastqc/) software
  to generate QC reports, followed by the [MultiQC](http://multiqc.info/)
